...
<div class="header">
    ...
    <nav class="navbar">
        ...
        <a href="#" id="view-cart" class="btn btn-dark" style="float: right; margin-right: 20px;">View Cart <i class="fas fa-cart-plus"></i></a>
    </nav>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success add-to-cart" data-id="<?php echo $row['id']; ?>"><i class="fas fa-cart-plus"></i></button>
...
<script type="text/javascript">
    ...
    function addToCart(itemId) {
        $.ajax({
            type: 'POST',
            url: 'add_to_cart.php', // PHP script to handle adding to cart
            data: {id: itemId},
