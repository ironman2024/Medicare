  ...
  <body>
    ...
    <section class="blogs" id="blogs">
        ...
        <div class="box-container">
            <div class="box">
                <div class="image">
                    <img src="./image/Product-Demand-Product-Safety-and-the-COVID-19-Pandemic.png" alt="">
                </div>
                <div class="content">
                    <div class="icon">
                        <a href="#"><i class="fas fa-calendar"></i>Delivery by 1st may, 2024</a>
                        <a href="#"><i class="fas fa-user"></i> by MedExpress</a>
                    </div>
                    <h3>Covid-19 Essentials</h3>
                    <p>Masks, sanitizer, thermometer, wipes, pain meds, tests, fluids, basic supplies for home isolation.</p>
                    <a href="covid-19essentials.php" class="btn">View Products <span class="fas fa-chevron-right"></span> </a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                ...
                <div class="content">
                    <div class="icon">
                        <a href="#"><i class="fas fa-calendar"></i> Delivery by 27th April, 2024</a>
                        <a href="#"><i class="fas fa-user"></i> by MedExpress</a>
                    </div>
                    <h3>Daily Care</h3>
                    <p>Daily care products cover essentials for hygiene (soap, shampoo), skin (lotion), and oral health, and deodorant.</p>
                    <a href="dailycare.php" class="btn">View Products <span class="fas fa-chevron-right"></span> </a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <img src="./image/diabetic.png" alt="">
                </div>
                <div class="content">
                    <div class="icon">
                        <a href="#"><i class="fas fa-calendar"></i> Delivery by 24th may, 2024</a>
                        <a href="#"><i class="fas fa-user"></i> by MedExpress</a>
                    </div>
                    <h3>Dibetic Needs</h3>
                    <p>Diabetics need monitors, test strips, insulin delivery tools, healthy food choices, and exercise for blood sugar management. </p>
                    <a href="DiabeticNeeds.php" class="btn">View Procucts <span class="fas fa-chevron-right"></span> </a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <img src="./image/babycare.png" alt="">
                </div>
                <div class="content">
                    <div class="icon">
                        <a href="#"><i class="fas fa-calendar"></i> Delivery by 23rd April, 2024</a>
                        <a href="#"><i class="fas fa-user"></i> by MedExpress</a>
                    </div>
                    <h3>Baby Care</h3>
                    <p>Baby care includes diapering, bathing, moisturizing, grooming, and feeding essentials for your little one's comfort</p>
                    <a href="babycare.php" class="btn">View Products <span class="fas fa-chevron-right"></span> </a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                ...
                <div class="content">
                    <div class="icon">
                        <a href="#"><i class="fas fa-calendar"></i> Delivery by 21st may, 2024</a>
                        <a href="#"><i class="fas fa-user"></i> by MedExpress</a>
                    </div>
                    <h3>Health & Nutrition</h3>
                    <p>Vitamins, minerals, supplements, and specialized drinks support health and dietary needs. </p>
                    <a href="Health&Nutrition.php" class="btn">View Procucts <span class="fas fa-chevron-right"></span> </a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <img src="./image/homeo.png" alt="">
                </div>
                <div class="content">
                    <div class="icon">
                        <a href="#"><i class="fas fa-calendar"></i> Delivery by Tomorrow</a>
                        <a href="#"><i class="fas fa-user"></i> by MedExpress</a>
                    </div>
                    <h3>Homeopathy</h3>
                    <p>Homeopathy offers ultra-diluted natural substances aiming to stimulate the body's healing response</p>
                    <a href="homeopathy.php" class="btn">View Procucts <span class="fas fa-chevron-right"></span> </a>
                </div>
            </div>
        </div>
        </div>
