...
<?php
$sql = "select * from items where category='Health & Nutrition';";
    ...
    <div class="row" style="display: inline-flex; margin-left: 25px;"> 
        <div class="card mb-3" style="width: 400px; margin-left: 20px;">
            <div class="row no-gutters">
                <div class="col-md-4">
                    <img src="../images/Health & Nutrition/<?php echo $row['img']; ?>" class="card-img" alt="img" style="margin-top: 20px;">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $row['name']; ?></h5>
                        <p class="card-text"><?php echo $row['description']; ?></p>
                        <a href="cart.php?id=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fas fa-cart-plus"></i> Add to Cart</a>
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-chevron-right"></i> Hygienic Packaging</a>
